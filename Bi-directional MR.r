...
#Bonferroni correction and export as xlsx table
mr_results_WrIvw$bonferroni <- p.adjust(mr_results_WrIvw$pval, method ="bonferroni")
write.xlsx(mr_results_other,"./aim2_other.xlsx")
write.xlsx(mr_results_WrIvw,"./aim2_WrIvw.xlsx")
